...
export default function MentorStudentVideoCall() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="bg-gray-800 rounded-lg shadow-lg p-8 max-w-md w-full">
        <h1 className="text-2xl font-bold text-white mb-6 text-center">Mentor-Student Video Call</h1>
        <p className="text-gray-400 mb-6 text-center">
          Join a video call session as either a mentor or student
        </p>
        ...
        <div className="mt-8 pt-6 border-t border-gray-700">
          ...
          <ol className="text-gray-400 text-sm space-y-2">
            <li className="flex items-start">
              ...
              <span>Enter the same session code on both mentor and student devices</span>
            </li>
            <li className="flex items-start">
