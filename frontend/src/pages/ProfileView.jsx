              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-slate-100">{userProfile.fullName}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500 dark:text-slate-400">School/College</p>
                    <p className="text-gray-900 dark:text-slate-100">{userProfile.schoolName}</p>
                  </div>
                  <div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-slate-100">
                      {userProfile.skillsToLearn || "No skills specified"}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-500 dark:text-slate-400">Skills to Teach</p>
                    <p className="text-gray-900 dark:text-slate-100">
                      {userProfile.skillsToTeach || "No skills specified"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-900 dark:text-slate-100">
                      {userProfile.learningGoals || "No goals specified"}
                    </p>
                  </div>
                  <div>
